...
nsc edit account --js-consumer 100 --js-disk-storage number 10M --js-ha-resources number 50 --js-mem-storage 5m --js-streams 100
nsc add user    myuser
...
nsc edit account2 --js-consumer 100 --js-disk-storage number 10M --js-ha-resources number 50 --js-mem-storage 5m --js-streams 100
nsc add user    myuser
